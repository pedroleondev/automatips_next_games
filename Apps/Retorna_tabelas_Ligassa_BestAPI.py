    ...
    def retorna_partidas(self, league_url):
        ...
        if response.status_code == 200:
            ...
            for i, df in enumerate(df_list):
                ...
                table.field_names = ['Hora', 'G x G', 'Casa vs Visitante', 'Resultado']
                table.align = 'l'

                # Mapear colunas para os novos cabeçalhos
                df.rename(columns={'Data': 'Hora', 'R': 'Gols x Gols', '-': 'Resultado'}, inplace=True)
